...
**For development patterns and best practices, see [DEVELOPMENT_GUIDE.md](./development-guide.md).**
...
[`docs/api-usage/01-authentication.md`](../reference/api/01-authentication.md#real-time-acl-events-stream-mercure-subscriber-bootstrap)
and [`docs/developer/13-acl-system.md`](./13-acl-system.md#real-time-acl-push-mercure).
