...
class RegistrationCodeService extends BaseService
{
    ...
    /**
     * @return array<int, array{id: string, code: string, id_groups: int|null, group_name: string|null, created_at: string}>
     */
    public function getAll(): array
    {
        $rows = $this->entityManager->getConnection()->fetchAllAssociative(
            'SELECT vc.code, vc.id_groups, g.name as group_name, vc.created
